...
## Github OAuth App
GITHUB_OAUTH_CLIENT_ID = '2d7d90e57166669c63788b50'
GITHUB_OAUTH_SECRET = '74e7e1837a98c7e0e4cd7fcf8b955894465964ec'

# Slack
## Slack App
SLACK_CLIENT_ID = '730191371696.1410179799078'
SLACK_CLIENT_SECRET = 'f90dd63cdcb555513662a6f4b008081c1524'

## Slack Signing Secret
SLACK_SIGNING_SECRET = 'f0c81213970d9c172fb35ec4c71aa536d401'
...
# Stripe
## Stripe Secret Key
STRIPE_SECRET_KEY = 'sk_live_abcdefghijklmnopfgfgfqrstuvwxyz0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'
...
# Square
## Square Access Token
SQUARE_ACCESS_TOKEN = 'sqOatp-TDt6aBq8Z_Oererup1JezKC1cK'

## Square OAuth Secret
SQUARE_OAUTH_SECRET = 'sq0csp-2WvLIfSstr6_FWefA3c prere_oeTw0RtICeBsIlUTShsRo'
...
# Twilio
## Twilio API Key
TWILIO_API_KEY = 'SK5d1d319A6Acf7EC3359BDeDb8CCe4D76BA8'
TWILIO_ACCOUNT_SID = 'ACXvJ0lkU-BhvkmBkZPUWAxExvPSF6s5En'
TWILIO_APP_SID = 'APNLX3uzXotXDUKvurSeS95o8O3RpYuuy6'

# Mailgun
## Mailgun API Key
MAILGUN_API_KEY = 'key-LPxoYCANGEFkAMHBu3455r4jTjbZ69ngpdbI'
...
## AWS Secret Access Key
VAR_2 = 'UpUbsQANRHLf2uuQ733333QOlNXPbbtV5fmseW/GgT5D/'
...
# Google
## GCP Credentials
VAR_4 = 'c4c474d61701fd6fd4191883555b8fea9a8411bf771'
VAR_5 = '-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n'
...
## Github OAuth App
VAR_11 = '2d7d90e5719c6378834343b50'
